(() => {
    ...
    (() => {
        ...
        window.popup = modules_flsModules.popup;
        ...
        function checkboxRaio() {
            let checkboxAll = document.querySelectorAll("[data-type]");
            if (!checkboxAll) return;
            function AddStructure() {
                for (let index = 0; index < checkboxAll.length; index++) {
                    let checkbox = checkboxAll[index];
                    let type = checkbox.attributes[1].value;
                    let Modif = checkbox.attributes[2].value;
                    let name = checkbox.attributes[3].value;
                    let value = checkbox.attributes[4].value;
                    let AtributsParent = {
                        class: `${type} ${type}__${type}--${Modif}`
                    };
                    let AtributsCheckbox = {
                        id: `c_${index}`,
                        type: `${type}`,
                        class: `${type}__input`,
                        value: `${value}`,
                    ...
                    if (type === "checkbox") {
                        console.log("чекбокс");
                        let СreateInput = document.createElement("input");
                        checkbox.prepend(СreateInput);
                        let input = checkbox.querySelector("input");
                        let lable = checkbox.querySelector("label");
                        lable.setAttribute("for", AtributsCheckbox.id);
                        setAttributes(checkbox, AtributsParent);
                        setAttributes(input, AtributsCheckbox);
                    } else if (type === "radio") {
                        console.log("радио");
                        let СreateInput = document.createElement("input");
                        checkbox.prepend(СreateInput);
        ...
        function rangeInit() {
            let rangeItems = document.querySelectorAll("[data-range]");
            if (rangeItems.length > 0) rangeItems.forEach((rangeItem => {
        ...
        function initSliders() {
            if (document.querySelectorAll(".swiper-first-section", ".slider-card-main", ".thumbs-big", ".thumbs-min", ".swiper-main-slider", ".swiper-services", ".swiper-news", ".swiper-catalog-slider", ".swiper-sorting", ".swiper-reviews-slider")) {
                new core(".swiper-first-section", {
                    ...
                    navigation: {
                        prevEl: ".first-section__button-prev",
                        nextEl: ".first-section__button-next"
                    },
                    breakpoints: {
                        320: {},
                        768: {},
                ...
                const swiperElements = document.querySelectorAll(".swiper-main-slider");
                swiperElements.forEach((swiperElement => {
                    new core(swiperElement, {
                        modules: [ Navigation ],
                        spaceBetween: 20,
                        navigation: {
                            prevEl: swiperElement.closest("section").querySelector(".button-slider_prev"),
                            nextEl: swiperElement.closest("section").querySelector(".button-slider_next")
                        },
                        breakpoints: {
                            320: {
                                slidesPerView: 2,
                ...
                new core(".thumbs-big", {
                    modules: [ Navigation, Controller, Thumb, Pagination ],
                    slidesPerView: "1",
                    spaceBetween: 10,
                    grabCursor: true,
                    ...
                    navigation: {
                        prevEl: ".thumbs-big-prev",
                        nextEl: ".thumbs-big-next"
                    },
                    pagination: {
                        el: ".swiper-pagination",
                        clickable: true
                ...
                new core(".thumbs-min", {
                    ...
                    slidesPerView: "auto",
                    navigation: {
                        prevEl: ".thumbs-min-prev",
                        nextEl: ".thumbs-min-next"
                    }
                });
                new core(".swiper-catalog-slider", {
                ...
                new core(".swiper-reviews-slider", {
                    modules: [ Navigation ],
                    slidesPerView: "auto",
                    spaceBetween: 10,
                    loop: true,
        ...
        modules_flsModules.tippy = tippy_esm(document.querySelectorAll(".hint-link"), {
            placement: "right-end",
            arrow: true,
            theme: "divano",
            content(reference) {
        ...
        modules_flsModules.tippy = tippy_esm(document.querySelectorAll(".tabs-tippy"), {
            placement: "right-end",
            arrow: true,
            theme: "tabs-tippy",
            content(reference) {
        ...
        function OpenCatalog() {
            let ButtonCatalog = document.querySelector(".ButtonCatalog");
            let ButtonRoom = document.querySelector(".ButtonRoom");
            let Catalog = document.querySelector(".menu-catalog");
            ButtonCatalog.addEventListener("click", (function(e) {
                if (ButtonCatalog.closest("._active")) {
                    ButtonCatalog.classList.remove("_active");
                    ButtonRoom.classList.remove("_active");
                    Catalog.classList.remove("_active");
                    document.querySelector("body").classList.remove("lock");
                } else {
                    ButtonCatalog.classList.add("_active");
                    ButtonRoom.classList.remove("_active");
                    document.querySelector(".menu-catalog__list.rums").classList.remove("_active");
                    document.querySelector("body").classList.add("lock");
                    Catalog.classList.add("_active");
                    document.querySelector(".menu-catalog__list.catalog").classList.add("_active");
                    ButtonCatalog.classList.remove("_active-rooms");
                }
            }));
            ButtonRoom.addEventListener("click", (function(e) {
                if (ButtonRoom.closest("._active")) {
                    ButtonRoom.classList.remove("_active");
                    ButtonCatalog.classList.remove("_active");
                    Catalog.classList.remove("_active");
                    ButtonCatalog.classList.remove("_active-rooms");
                    ...
                    ButtonRoom.classList.add("_active");
                    ButtonCatalog.classList.remove("_active");
                    Catalog.classList.add("_active");
                    document.querySelector(".menu-catalog__list.catalog").classList.remove("_active");
                    document.querySelector(".menu-catalog__list.rums").classList.add("_active");
                    document.querySelector("body").classList.add("lock");
                    ButtonCatalog.classList.add("_active-rooms");
                }
            }));
        ...
        OpenCatalog();
        let NavMob = document.querySelectorAll(".mob-menu__navigation ul a");
        console.log(NavMob);
        NavMob.forEach((link => {
        ...
        let Filtr = document.querySelector(".catalog-filter");
        let FiltrCloce = document.querySelector(".catalog-filter__close");
        let OpenFilter = document.querySelector(".open-catalog");
        if (Filtr) {
            OpenFilter.addEventListener("click", (function(e) {
                Filtr.classList.add("open-filter");
            }));
            FiltrCloce.addEventListener("click", (function(e) {
                Filtr.classList.remove("open-filter");
            }));
        }
        let MainCartBtnQuantity = document.querySelectorAll(".MainCartBtn");
        MainCartBtnQuantity.forEach((element => {
            element.addEventListener("click", (function(e) {
                QuantityShow(element);
            }));
        }));
        function QuantityShow(Btn) {
            Btn.classList.add("none");
            Btn.nextElementSibling.classList.add("show-quantity");
            Btn.closest(".card-main").querySelector(".comparison").classList.add("_active");
        }
        isWebp();
        menuInit();
        spollers();
